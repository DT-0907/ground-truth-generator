...
Ported from software2/cctv_yolo/processor.py for the test/dev Flask version.
"""
...
def process_video(video_path: str, output_dir: str = "data/tracks",
                  ...
                  models_dir: str = None, processing_roi: dict = None) -> dict:
    """
    ...
    Args:
        ...
        models_dir: Optional path to local models directory
        processing_roi: Optional ROI dict to filter detections
    ...
    # Load YOLO model -- check local models dir first
    if models_dir:
