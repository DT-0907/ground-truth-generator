"""
Settings tab — local folder shortcuts and NAS connection management.
...
class SettingsTab(QWidget):
    """Settings tab content — local folders and NAS connection."""
    ...
    def _connect_nas(self):
        ...
        if success and mount_point:
            ...
            # Switch data manager to NAS mode
            ...
            self.lbl_nas_message.setStyleSheet("color: #e74c3c; font-size: 12px;")
